...
class VoiceManager {
    ...
    OnPlayerTalking = (teamSpeakName, isTalking) => {
        ...
        if (voiceClient != null) {
            ...
            alt.emit("client:SaltyChat_IsTalking", this.VoiceRange > 0 ? isTalking : false); //ToDo
        }
    }
        ...
        switch (message.Command) {
            ...
            case Command.SoundState:
                if (parameter.IsMicrophoneMuted != this.IsMicrophoneMuted) {
                    ...
                    alt.emit("Client:SaltyChat:MicStateChanged", this.IsMicrophoneMuted, this.VoiceRange);
                }
